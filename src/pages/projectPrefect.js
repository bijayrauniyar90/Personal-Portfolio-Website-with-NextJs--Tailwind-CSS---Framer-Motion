...
const Project = ({ title, type, img, link, github }) => {
  return (
    ...
    border border-solid border-dark bg-light p-6 relative shadow-lg"
    >
      <div
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center">
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 gap-y-32">
            ...
            {[1, 2, 3, 4].map((item) => (
              <div className="col-span-6" key={item}>
                <Project
                  title={`Project ${item}`}
                  img={project1}
                  summary="A brief description of the project goes here. It highlights the key features and technologies used."
                  link="/"
                  github="/"
